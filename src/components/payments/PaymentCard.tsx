...
const PaymentCard = ({ event, open, onOpenChange, onPaymentCollected }: PaymentCardProps) => {
  ...
  const collectPayment = async () => {
    ...
    try {
      ...
      console.log('🔍 DEBUG - Payment notification data:', {
      ...
      if (event.client?.phone) {
        console.log('📞 Sending payment notification to:', event.client.phone);
        ...
        console.warn('⚠️ No client phone number found - payment notification skipped');
      }
