...
export type TaskStatus = 'Pending' | 'In Progress' | 'Completed' | 'Under Review' | 'On Hold' | 'Waiting for Response' | 'Accepted' | 'Declined';
...
// Database representation of Task (with Json types)
...
// Re-export auth types inline to remove file dependency
...
export const EVENT_TYPE_COLORS = {
  'Ring-Ceremony': 'bg-rose-100 text-rose-800 border-rose-200',
  'Pre-Wedding': 'bg-pink-100 text-pink-800 border-pink-200', 
  'Wedding': 'bg-red-100 text-red-800 border-red-200',
  'Maternity Photography': 'bg-purple-100 text-purple-800 border-purple-200',
